...
<section id="contact">
  <div class=" bg-primary px-6 py-10 sm:py-32 lg:px-8">
    ...
    <div class="mx-auto max-w-2xl text-center">
      ...
      <p class="mt-2 text-lg leading-8 text-gray-600">Let me know how I can help you!</p>
    </div>
    <form action="https://api.web3forms.com/submit" method="POST" class="mx-auto mt-16 max-w-xl sm:mt-20">
      ...
      <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
        ...
        <div class="sm:col-span-2">
          ...
          <div class="mt-2.5">
            <input type="email" placeholder="email@gmail.com" name="email" id="email" autocomplete="email" class="block w-full rounded-md border-0 px-3.5 py-2 text-white shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-gray-100 sm:text-sm sm:leading-6 bg-color1" required>
          </div>
        </div>
        ...
        <div class="sm:col-span-2">
          ...
          <div class="mt-2.5">
            <textarea name="message" placeholder="Message.." id="message" rows="4" class="block w-full rounded-md border-0 px-3.5 py-2 text-white shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-gray-100 sm:text-sm sm:leading-6 bg-color1" required></textarea>
          </div>
        </div>
        
      </div>
      <div class="mt-10">
        <button type="submit" class="block w-full rounded-md bg-color1 px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-gray-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-100">Send Message</button>
      </div>
    </form>
  </div>
  </section>